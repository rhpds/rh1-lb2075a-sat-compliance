# rh1-lb2075a-sat-compliance

A hands on lab that delves into Red Hat Satellite features such as compliance monitoring and scanning, image mode, and vulnerability detection and remediation.

**Owner:** myee111
**Migrated from:** https://github.com/rhpds/zt-satellite-compliance
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/rh1-lb2075a-sat-compliance`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/rh1-lb2075a-sat-compliance
   ```
3. `cd rh1-lb2075a-sat-compliance`
